...
public class BottomBarItem extends LinearLayout {
    ...
    private void checkValues() {
        ...
        if (mUnreadTextBg == null){
            mUnreadTextBg = getResources().getDrawable(R.drawable.green_radius_27);
        }

        if (mMsgTextBg == null){
            mMsgTextBg = getResources().getDrawable(R.drawable.circle_green);
        }

        if (mNotifyPointBg == null){
            mNotifyPointBg = getResources().getDrawable(R.drawable.green_radius_27);
        }
    }
